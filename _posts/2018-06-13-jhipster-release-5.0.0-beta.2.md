...
- Initial [Istio](https://istio.io/) support has been added in [#7695](https://github.com/jhipster/generator-jhipster/pull/7695) by [Ray Tsang](https://github.com/saturnism) from Google, with the help of [Pierre Besson](https://github.com/PierreBesson) and [Srinivasa Vasu](https://github.com/srinivasa-vasu).

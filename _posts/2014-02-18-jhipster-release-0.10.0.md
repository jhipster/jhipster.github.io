...
* Thymeleaf support! For those cases when a single Web page application is not enough, we added the Thymeleaf template engine to JHipster. Have a look at the new src/main/resources/templates/error.html file, which now serves correctly your 404 ou 500 errors!

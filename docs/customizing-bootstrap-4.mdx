...
:::warning
Bootstrap 4 has reached [end of life](https://getbootstrap.com/docs/4.6/end-of-life/). Consider upgrading to the latest [Bootstrap 5](https://getbootstrap.com/docs/5.3/migration/) and check out the [latest version](/customizing-bootstrap-5) of this page.
:::

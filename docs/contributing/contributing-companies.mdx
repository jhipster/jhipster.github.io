...
* [Okta](https://developer.okta.com/), which provides time and hardware to [@mraible](https://x.com/mraible) to improve the project. They also contributed the [OIDC support](/security/#oauth-20-and-openid-connect) and [Ionic module](/modules/marketplace/details/generator-jhipster-ionic/).
...
* [Redhat](https://www.redhat.com/en) contributed the [Openshift sub-generator](/openshift/) and Infinispan support.

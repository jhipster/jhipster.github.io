...
slug: /2014/11/26/jhipster-release-1.10.0.html
...
- We have a new "fast" profile, which is documented [here](/profiles/). You can expect to start up a JHipster application in 4 seconds!

---
title: Release 4.0.6
slug: /2017/02/21/jhipster-release-4.0.6.html
...
- Continuous Integration support has been moved to a specific sub-generator, and now supports Jenkins, Travis, GitLab and CircleCI. You can find more information on our [Continuous Integration documentation](/setting-up-ci/).

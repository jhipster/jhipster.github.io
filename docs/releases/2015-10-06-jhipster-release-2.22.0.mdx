...
slug: /2015/10/06/jhipster-release-2.22.0.html
...
Our [documentation page](/docker-compose/) is already available so you can start using this new feature straight away, but as this is very new it still has the __BETA__ tag, and we are awaiting your feedback.

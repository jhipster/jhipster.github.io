---
title: Release 5.2.0
slug: /2018/08/14/jhipster-release-5.2.0.html
...
Please note that we have launched a [bug bounties program](/bug-bounties/) and that several important tickets have been closed thanks to this. At the moment, we have $2,000 on this program thanks to our awesome sponsors, through our [OpenCollective initiative](https://opencollective.com/generator-jhipster).

...
slug: /2015/12/16/jhipster-release-2.26.0.html
...
Everybody has been waiting for this for a long time, our [marketplace](/modules/marketplace/) is now open!

You can code your own modules, with all the power of the JHipster sub-generators, but without having to be part of the project: anybody can code and publish them easily, just follow our [documentation here](/modules/creating-a-module/).

---
title: Release 1.7.0
slug: /2014/11/05/jhipster-release-1.7.0.html
...
The main new improvement of this release is the Cloud Foundry sub-generator. It is working so well that we didn't put the BETA tag on it (unlike our Heroku and OpenShift sub-generators). If you [Check the code](https://github.com/jhipster/generator-jhipster/tree/v1.7.0/cloudfoundry) you can also see how small and clean it is.

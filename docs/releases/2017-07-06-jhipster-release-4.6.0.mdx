---
title: Release 4.6.0
slug: /2017/07/06/jhipster-release-4.6.0.html
...
The JHipster Module sub generator is deprecated. We now recommend using commonJS or ES6 require/import to get `generator-base` in order to use our Public API. See [creating a module](/modules/creating-a-module/) page for more details.

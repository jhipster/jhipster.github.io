---
title: Release 5.0.2
slug: /2018/07/05/jhipster-release-5.0.2.html
...
- Blueprint support has been greatly enhanced, and most importantly documented on the new ["Creating a blueprint" page](/modules/creating-a-blueprint/).

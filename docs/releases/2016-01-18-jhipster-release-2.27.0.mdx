...
slug: /2016/01/18/jhipster-release-2.27.0.html
...
- We have a brand new [hook](/modules/creating-a-module/#hooks) mechanism from the entity sub generator. This will be triggered post creation of an entity and it will invoke modules registered for this event. This enables use of modules to add additional features to generated entity, like [enable audit](/modules/marketplace/details/generator-jhipster-entity-audit/), add prefix etc.

---
title: Release 3.0.0
slug: /2016/03/23/jhipster-release-3.0.0.html
...
After months of efforts, with a [great international team](/team/), our 3.0.0 version is out!
...
- [Monitoring your JHipster Applications](/monitoring/)
...
- [JDL](/jdl/intro/) is now a first class citizen with the new `import-jdl` sub generator.
- The entity sub-generator got many new features like option to update existing entities, custom table name, AngularJS suffix etc. Check the documentation [here](/creating-an-entity/) for details.
- The `fast` profile has been removed and instead you now have profile switches. Check the documentation [here](/profiles/) for details.
- We have changed the way application is packaged, to improve performance. Find more details [here](/production/).

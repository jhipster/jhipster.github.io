---
title: Release 4.0.0
slug: /2017/02/02/jhipster-release-4.0.0.html
...
This would never have been possible without our wonderful [core dev team](/team/) and our incredible number of [contributors](https://github.com/jhipster/generator-jhipster/graphs/contributors)! Thank you so much, everyone!
...
As this is a major upgrade, expect quite a lot of merges if you use our [JHipster upgrade sub-generator](/upgrading-an-application/) on an existing application.
...
To use our [JHipster upgrade sub-generator](/upgrading-an-application/), run:

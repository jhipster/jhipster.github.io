---
title: Release 4.0.3
slug: /2017/02/13/jhipster-release-4.0.3.html
...
One big improvement is that you are now able to use the [JHipster Registry](/jhipster-registry/) with a monolith application, in order to use a distributed Hazelcast cache. You can find more information about this on our ["Using a cache" documentation](/using-cache/).

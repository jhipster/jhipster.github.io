---
title: Release 4.1.1
slug: /2017/03/23/jhipster-release-4.1.1.html
...
- With this release, the [JHipster upgrade sub-generator](/upgrading-an-application/) is working again! As this is a small patch release, this is the good moment for everyone to test it! If you have it working (or not!), don't hesitate to tweet it and mention [@jhipster](https://twitter.com/jhipster).

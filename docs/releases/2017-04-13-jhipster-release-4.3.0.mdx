---
title: Release 4.3.0
slug: /2017/04/13/jhipster-release-4.3.0.html
...
- Angular CLI is now officially supported, you can find a complete documentation [here](/using-angular/).
...
- The upgrade sub-generator has been improved, its updated documentation is [here](/upgrading-an-application/).

---
title: Release 3.4.1
slug: /2016/06/13/jhipster-release-3.4.1.html
...
- The "Upgrade sub-generator" has been modified, please read [#3696](https://github.com/jhipster/generator-jhipster/issues/3696) before using it! This website has been updated with the latest documentation, be sure to read [JHipster upgrade sub-generator](/upgrading-an-application/) before running the sub-generator.

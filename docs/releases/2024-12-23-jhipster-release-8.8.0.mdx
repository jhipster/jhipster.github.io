...
It includes [534 closed issues and pull requests on the main branch](https://github.com/jhipster/generator-jhipster/issues?q=is:closed+milestone:8.8.0) after the [8.7.3 release](/2024/11/01/jhipster-release-8.7.3.html).

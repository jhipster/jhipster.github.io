---
title: Release 1.3.0
slug: /2014/10/07/jhipster-release-1.3.0.html
...
- The entity sub-generator has been greatly improved, and can now generate a whole CRUD application, from database to HTML. Please check our [updated documentation](/creating-an-entity/).

...
slug: /2015/05/28/jhipster-release-2.13.0.html
...
DTO support is done with [MapStruct](http://mapstruct.org/) and is [fully documented here](/using-dtos/). It is still considered of _BETA_ quality has it involves a lot of change in the code. As always, we follow our "release early, release often" motto, and will gather feedback during the next weeks before removing the _BETA_ tag.

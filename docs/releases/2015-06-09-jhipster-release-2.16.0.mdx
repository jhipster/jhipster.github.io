...
slug: /2015/06/09/jhipster-release-2.16.0.html
...
- [Support for the Oracle database](/using-oracle/) is now available! And this is not part of any "enterprise" offering :-)
...
- Grunt should now run faster, as it doesn't use the `concurrent` task anymore. There is a new [tip to turn it back on](/tips/005_tip_concurrent_task_grunt.html) if needed

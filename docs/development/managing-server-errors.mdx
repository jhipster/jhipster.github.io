...
- [Problem with message](/problem/problem-with-message)
- [Constraint violation](/problem/constraint-violation)
- [Problem with a parameterized message](/problem/parameterized)
- [Entity not found](/problem/entity-not-found)
- [Invalid password](/problem/invalid-password)
- [E-mail already used](/problem/email-already-used)
- [Login already used](/problem/login-already-used)
- [E-mail not found](/problem/email-not-found)

...
> You should use the new [swagger2markup](https://github.com/atomfrede/generator-jhipster-swagger2markup) module instead of following this tip! See the [JHipster Marketplace](https://jhipster.github.io/modules/marketplace/) for details about the module system.

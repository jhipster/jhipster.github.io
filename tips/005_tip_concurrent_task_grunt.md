...
If you have loats of images, svg files, a compass task with lots of sass files and Coffescript tasks to run, you can consider using `concurrent` to spawn multiple threads to run those time consuming tasks in parellel.

...
1. Use the App Engine plugin to deploy: `./mvnw clean && ./mvnw package appengine:deploy -DskipTests -Pgae,prod-gae` or using Gradle `./gradlew clean && ./gradlew appengineDeploy -Pgae -Pprod-gae`

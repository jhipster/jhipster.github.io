...
3. [The JHipster API gateway](#gateway)
  a. [HTTP routing](#http_routing)
  b. [Security](#security)
  c. [Automatic documentation](#documentation)
  d. [Rate limiting](#rate_limiting)
  e. [Access control policy](#acl)
4. [The JHipster Registry](#registry)
  a. [JHipster Registry overview](#registry_overview)
  b. [Securing the JHipster Registry](#securing_registry)
  c. [Application configuration with the JHipster Registry](#registry_app_configuration)
5. [Creating microservices](#microservices)
  a. [Generating entities](#generating_entities)
  b. [Distributed caching with HazelCast](#hazelcast)
  c. [Microservices with no database](#no_database)
6. [Using Docker Compose](#docker_compose)
7. [Monitoring with JHipster Console and the ELK stack](#monitoring)
8. [Production](#production)
  a. [Going to production with Docker Swarm](#docker_swarm)
  b. [Going to production with CloudFoundry](#cloudfoundry)
  c. [Going to production with Heroku](#heroku)

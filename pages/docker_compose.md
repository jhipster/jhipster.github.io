...
Docker image building relies on [Jib](https://github.com/GoogleContainerTools/jib) (supported by the Google Container Tools team). It provides a Maven and Gradle plugin to containerize Java application in a better way. Rather than using the classical *fat-jar* approach, Jib separates your code, dependencies and resources into multiple layers.

More details about Jib on the [official jib blog post](https://cloudplatform.googleblog.com/2018/07/introducing-jib-build-java-docker-images-better.html).

_Note: To help you to transition smoothly to Jib, JHipster still generates a classic `Dockerfile`._
...
- With Gradle, type: `./gradlew bootWar -Pprod jibDockerBuild`

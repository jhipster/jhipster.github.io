---
layout: default
title: Erreur - nom d'utilisateur déjà utilisé
...
## <i class="fa fa-warning"></i> Erreur : nom d'utilisateur déjà utilisé

### Description de l'erreur

Il s'agit d'une erreur de JHipster qui est utilisée lorsque l'utilisateur final essaie d'utiliser un nom d'utilisateur qui est déjà utilisé.

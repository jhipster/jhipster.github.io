...
The configuration will be stored in a generated `.yo-rc.json` file, so it is **strongly** recommanded to not generate a JHipster project in your HOME directory. If you did it, you won't be able to generate another project in a sub directory. To solve it, simply delete the `.yo-rc.json` file.

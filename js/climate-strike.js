(function() {
    ...
    function initializeInterface() {
      ...
      injectCSS('DIGITAL_STRIKE_CSS',
        '#' + DOM_ID + ' { position: fixed; right: 0; left: 0; bottom: 0px; width: 100%; height: ' + iFrameHeight + '; z-index: 990000; -webkit-overflow-scrolling: touch; overflow: hidden; background: rgba(78, 229, 139, 1); } ' +

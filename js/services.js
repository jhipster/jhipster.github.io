    ...
    function ModuleService($http) {
        ...
        return {
            ...
            getAllModules: function (start, size) {
                ...
                return $http.get(window.location.protocol + '//npmsearch.com/query?fields=name,keywords,description,author,homepage,version,repository,created&q=keywords:jhipster-module&from='+ start +'&size=' + size).success(function (resp) {
                    return resp;
                });
            },
